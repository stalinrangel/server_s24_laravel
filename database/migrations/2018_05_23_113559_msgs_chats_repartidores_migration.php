...
class MsgsChatsRepartidoresMigration extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('msgs_chats_repartidores', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('chat_id')->references('id')->on('chats_repartidores');
    ...
    {
        Schema::drop('msgs_chats_repartidores');
    }
}
