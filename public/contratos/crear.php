...
$contenido = '<html><body>
				...
				<p style="text-align: justify;">Departamento de Canelones, el día '.$fecha.' entre <b>“Service24”</b>, y por la otra, <b>'.$nombre.'</b> de C.I '.$ci.' quien en lo sucesivo se denominará <b>“El Proveedor”</b>, se ha convenido en celebrar el presente contrato de conformidad con los términos y condiciones siguientes:
				</p>
        ...
        <p><b>“Service 24”</b>:  Dirección: Departamento de Canelones, Teléfono: 59898751288</p>

        <p><b>“EL Proveedor”</b>: Dirección: '.$direccion.', Teléfono: '.$telefono.'</p>

        <p><b>K- ARBITRAJE:</b> Cualquiera controversia que surja por razón de interpretación, ejecución o incumplimiento del presente contrato, será resuelta entre las partes. En caso de que las partes no logren llegar a un acuerdo, entonces se resolverá mediante arbitraje en Derecho ante el Centro de Conciliación y Arbitraje de la Cámara de Comercio de la Departamento de Canelones, de conformidad con sus normas y reglamentos de procedimiento. Para estos efectos, cada parte designará a un árbitro y éstos, a su vez, designarán a un tercero, quienes conformarán el Tribunal Arbitral. La decisión adoptada por dicho tribunal será final, definitiva y de obligatorio cumplimiento para las partes, por lo que la misma no podrá ser impugnada ante los tribunales de justicia. La parte vencida pagará los costos, gastos y honorarios incurridos en el proceso arbitral. El arbitraje se conducirá en idioma castellano.</p>

        <p><b>L- DOMICILIO:</b> Las partes contratantes eligen como domicilio especial a la ciudad de Departamento de Canelones para todos los efectos, derivados y consecuencias de este contrato. En Departamento de Canelones, '.$fecha.'</p>
        <div align="center">
